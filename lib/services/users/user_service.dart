...
import 'package:socially/services/auth/auth_servie.dart' as auth_service;
...
class UserService {
  ...
  Future<void> saveUser(UserModel user) async {
    try {
      ...
      final userCredential = await auth_service.AuthService().createUserWithEmailAndPassword(
        email: user.email,
